...
define('SUPPORT_EMAIL', 'razaviby@gmail.com');
define('SUPPORT_FROM_EMAIL', 'razaviby@gmail.com');
define('SUPPORT_CHAT_ADMIN_EMAIL', 'razaviby@gmail.com');
define('SMTP_HOST', 'smtp.gmail.com');
define('SMTP_PORT', 465);
define('SMTP_USERNAME', 'razaviby@gmail.com');
define('SMTP_PASSWORD', 'rjokorgemqzfujrv');
